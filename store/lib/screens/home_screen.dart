...
import 'package:store/services/get_category_service.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  late Future<List<ProductModel>> futureCategory;
  ...
  void initState() {
    ...
    futureCategories = GetAllCategoriesService().getAllCategories();
  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          futureCategory = GetCategoryService().getCategory(
